...
class Withdrawer2 extends StatefulWidget {
  Withdrawer2({Key key}) : super(key: key);

  @override
  State<Withdrawer2> createState() => _Withdrawer2State();
}

class _Withdrawer2State extends State<Withdrawer2> {
    ...
    {
      {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            ...
            content: Text('Your withdrawer is pending'),
          ),
        );
      }
