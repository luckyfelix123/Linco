...
class Vip1Loging extends StatefulWidget {
  const Vip1Loging({Key key}) : super(key: key);

  @override
  _Vip1LogingState createState() => _Vip1LogingState();
}

class _Vip1LogingState extends State<Vip1Loging> {
...
try{   
  ...
  await FirebaseFirestore.instance.collection('Vip1 new users').doc(name).collection('NewMember').get();
  Navigator.push(context, MaterialPageRoute(builder: (_)=> Linco()),);
                ...
                height: 130,
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        ...
                        image: NetworkImage('https://image.shutterstock.com/image-vector/luxury-vip-member-badge-composed-260nw-237706195.jpg')
