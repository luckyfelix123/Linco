...
class Vip1Signup extends StatefulWidget {
  Vip1Signup({Key key}) : super(key: key);

  @override
  State<Vip1Signup> createState() => _Vip1SignupState();
}

class _Vip1SignupState extends State<Vip1Signup> {
...
//               ),
              ...
              Row(
                ...
                children: [
                  // SizedBox(width: 90),
                  Text(
                    "it is time to create an account for vip1",
