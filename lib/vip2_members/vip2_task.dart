...
class Vip2Task extends StatefulWidget {
  String TaskRecordRoomId;

  Vip2Task({Key key, this.TaskRecordRoomId}) : super(key: key);

  @override
  State<Vip2Task> createState() => _Vip2TaskState();
}

class _Vip2TaskState extends State<Vip2Task> {
  double amount = 85;
  int dec = 10;
  int inc = 0;
  int counter = 85;
