...
class FlutterWaveMigratePayment extends StatefulWidget {
  FlutterWaveMigratePayment({Key key, this.title}) : super(key: key);

  final String title;
  @override
  _FlutterWaveMigratePaymentState createState() => _FlutterWaveMigratePaymentState();
}

class _FlutterWaveMigratePaymentState extends State<FlutterWaveMigratePayment> {
