...
class Vip2Audition extends StatefulWidget {
  const Vip2Audition({Key key}) : super(key: key);

  @override
  State<Vip2Audition> createState() => _Vip2AuditionState();
}

class _Vip2AuditionState extends State<Vip2Audition> {
  String _timeString;
