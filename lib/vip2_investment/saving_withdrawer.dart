...
class SavingWithdraw2 extends StatefulWidget {
  SavingWithdraw2({Key key}) : super(key: key);

  @override
  State<SavingWithdraw2> createState() => _SavingWithdraw2State();
}

class _SavingWithdraw2State extends State<SavingWithdraw2> {
