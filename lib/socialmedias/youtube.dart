...
class _YoutubeState extends State<Youtube> {
  ...
  void onSendMessage(BuildContext context) async {
    Map<String, dynamic> messages = {
      ...
      "instruction":'Take a screenshot  according to what is on the link and send it to this email (intendcheck1@gmail.com),with your own wallet email for confirmation',
      "status": 'reviewing',
      "status2": 'aproved',
      'leading':
...
//                       //             backgroundImage: NetworkImage(map['leading']),
//                       //           ),
//                       //           title: Text(map['requested']),
//                       //           subtitle: Text(
//                       //             map['amount'],
//                       //             style: TextStyle(
//                       //                 fontSize: 17, color: Colors.orange[500]),
//                       //           ),
