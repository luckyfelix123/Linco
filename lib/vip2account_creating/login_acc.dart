...
class Vip2Loging extends StatefulWidget {
  const Vip2Loging({Key key}) : super(key: key);

  @override
  _Vip2LogingState createState() => _Vip2LogingState();
}

class _Vip2LogingState extends State<Vip2Loging> {
...
try{   
  ...
  await FirebaseFirestore.instance.collection('Vip2 new users').doc(name).collection('NewMember').get();
