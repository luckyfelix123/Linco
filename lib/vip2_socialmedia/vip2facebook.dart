...
class Vip2Facebook extends StatefulWidget {
  final TaskModel task;
  String TaskRecordRoomId;
  Vip2Facebook({Key key, this.TaskRecordRoomId, this.task}) : super(key: key);

  @override
  _Vip2FacebookState createState() => _Vip2FacebookState();
}

class _Vip2FacebookState extends State<Vip2Facebook> {
  bool ontap = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('Vip2 Facebook ').snapshots(),
          builder:
