...
class Vip2Instagram extends StatefulWidget {
  const Vip2Instagram({Key key}) : super(key: key);

  @override
  _Vip2InstagramState createState() => _Vip2InstagramState();
}

class _Vip2InstagramState extends State<Vip2Instagram> {
