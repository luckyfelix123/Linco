...
class InvestFlutterWave extends StatefulWidget {
  ...
  @override
  _InvestFlutterWaveState createState() => _InvestFlutterWaveState();
}

class _InvestFlutterWaveState extends State<InvestFlutterWave> {
  ...
  void checkValues() {
    ...
    if (name == '' || emails == "" || number == ""||amount=="") {
      ...
      FirebaseFirestore.instance
          ...
          .doc(email.currentUser.uid).collection('From vip 1') 
          .add(account);
