...
class Vip1Facebook extends StatefulWidget {
  final TaskModel task;
  String TaskRecordRoomId;
  Vip1Facebook({Key key, this.TaskRecordRoomId, this.task}) : super(key: key);

  @override
  _Vip1FacebookState createState() => _Vip1FacebookState();
}

class _Vip1FacebookState extends State<Vip1Facebook> {
  bool ontap = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('Vip1 task').snapshots(),
          builder:
