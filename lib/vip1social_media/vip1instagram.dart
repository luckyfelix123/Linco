...
class Vip1Instagram extends StatefulWidget {
  const Vip1Instagram({Key key}) : super(key: key);

  @override
  _Vip1InstagramState createState() => _Vip1InstagramState();
}

class _Vip1InstagramState extends State<Vip1Instagram> {
